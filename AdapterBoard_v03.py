...
class MultiAdapter:
    ...
    def choose_channel(self,index):
        ...
        print('system cmd: ' + str(channel_info["i2c_cmd"]))
        os.system(channel_info["i2c_cmd"]) # i2c write
        print('gpio config: ' + str(channel_info["gpio_sta"]))
    ...
    def init(self,width,height):
        for i in index_set: #originally range(4)
    ...
    def preview(self):
        ...
        while True:
            ...
            if i == 0:
                ...
                index = chr(65+i)
            i = i+2 #bounce from 0 to 2 (need to change if have more cameras)
            if i==4:
                i = 0
